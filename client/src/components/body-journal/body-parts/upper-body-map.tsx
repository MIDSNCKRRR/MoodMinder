...
export default function UpperBodyMap({ selectedFeelings, onFeelingChange }: UpperBodyMapProps) {
  const upperBodyParts = [
    ...
    { id: "chest", label: "Chest", x: 50, y: 40 },
    { id: "heart", label: "Heart", x: 45, y: 45 },
    { id: "stomach", label: "Stomach", x: 50, y: 65 },
    { id: "left-arm", label: "Left Arm", x: 25, y: 50 },
    { id: "right-arm", label: "Right Arm", x: 75, y: 50 },
    { id: "left-hand", label: "Left Hand", x: 15, y: 80 },
    { id: "right-hand", label: "Right Hand", x: 85, y: 80 },
  ];
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Your uploaded Upper Body image */}
