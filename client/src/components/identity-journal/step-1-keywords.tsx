...
export default function Step1Keywords({
  ...
  const candidateWords =
    selectedCategory === "adjectives" ? adjectiveWords : characterWords;

  // Auto-save keywords
  useEffect(() => {
    localStorage.setItem(
      "identityJournal_keywords",
              ...
              <button
                ...
                className={`px-4 py-2 rounded-stone text-sm font-medium transition-all duration-300 ${
                  selectedCategory === "adjectives"
                    ? "bg-sage-600 text-sage-50 shadow-lg"
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {selectedKeywords
                  ...
                  .map((keyword) => {
                    ...
                    const categoryLabel = isFromAdjectives
                      ? "Adjective"
                      : "Character";
                    const categoryColor = isFromAdjectives
